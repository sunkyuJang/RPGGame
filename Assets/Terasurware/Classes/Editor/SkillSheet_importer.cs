		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(10); p.StartFrom = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(11); p.EndFrom = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(12); p.AttackType = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(13); p.IsDetectCollision = (cell == null ? false : cell.BooleanCellValue);
					...
					cell = row.GetCell(16); p.ParentIndex = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(17); p.SkillTier = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(18); p.BuffIndex = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(19); p.DebuffIndex = (int)(cell == null ? 0 : cell.NumericCellValue);
						s.list.Add (p);
					}
					data.sheets.Add(s);
				}
